...
# Download the jQCloud files. Place jqcloud-0.1.3.js (or the minified version jqcloud-0.1.3.min.js) and jqcloud.css somewhere in your project and import both of them in your HTML code.
...
<html>
  <head>
    ...
    <script type="text/javascript" src="jqcloud-0.1.3.js"></script>
...
bc. $("#wordcloud").jQCloud(word_list, function(){
...
0.1.3 Added possibility to define a callback and to specify a custom title attribute for each word in the cloud
