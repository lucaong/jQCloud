...
# Download the jQCloud files. Place "jqcloud-0.2.3.js":https://raw.github.com/DukeLeNoir/jQCloud/master/jqcloud/jqcloud-0.2.3.js (or the minified version "jqcloud-0.2.3.min.js":https://raw.github.com/DukeLeNoir/jQCloud/master/jqcloud/jqcloud-0.2.3.min.js) and "jqcloud.css":https://raw.github.com/DukeLeNoir/jQCloud/master/jqcloud/jqcloud.css somewhere in your project and import both of them in your HTML code.
...
<html>
  <head>
    ...
    <script type="text/javascript" src="jqcloud-0.2.3.js"></script>
...
* *randomClasses* (number): If higher than 0, each word will be assigned randomly to a class of kind @r1@, @r2@, ..., @rN@ with N = randomClasses. This random class can be used for random CSS styling of words, for example to set a random color or random orientation (see @examples/vertical_words.html@).
