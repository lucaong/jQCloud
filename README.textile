...
# Download the jQCloud files. Place jqcloud-0.1.6.js (or the minified version jqcloud-0.1.6.min.js) and jqcloud.css somewhere in your project and import both of them in your HTML code.
...
0.1.6 JavaScript friendly URL escape of 'url' option; Typecast of 'weight' option to float (thanks to "nudesign":https://github.com/nudesign)
