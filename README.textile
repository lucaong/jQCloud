...
<script type="text/javascript">
  ...
  // url: [optional] a URL to which the word must be linked
...
* Specify the style of the words (color, font, dimension, etc.). Words will be wrapped in <pre><code><span></code></pre> tags with ten levels of importance corresponding to the following classes (in descending order of importance): w10, w9, w8, w7, w6, w5, w4, w3, w2, w1. See the file jqcloud.css for reference.